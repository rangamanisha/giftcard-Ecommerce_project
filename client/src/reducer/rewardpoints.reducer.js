...
import {getRewardPointsAction, getTransactionsAction, getConvertAction, getRemainingAction, getConvertCreditsAction } from "../actions/rewardpoints.actions";
...
export const initialRewardPointsState = rewardpointsAdapter.getInitialState(REWARDS_POINTS_INITIAL_STATE);
...
export const rewardpointsSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder.addCase(getRewardPointsAction.pending, (state, action) => {
            state.code = true;
        })
