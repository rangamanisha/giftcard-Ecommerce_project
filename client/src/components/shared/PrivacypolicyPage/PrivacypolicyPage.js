                ...
                <div className='row mx-5'>
                    ...
                    <div className="col-3 offset-1 sticky-top privacy-container">
                            <div className='d-flex flex-column justify-content-between p-2'>
                                <div className='privacy-item-style'><a href='#welcome' tabindex='1'>Welcome to Gifti Global</a></div>
                                ...
                                <div className='privacy-item-style'>HOW WE WILL USE YOUR INFORMATION</div>
                                <div className='privacy-item-style'><a href='#rights' tabindex='2'>INTELLECTUAL PROPERTY RIGHTS</a></div>
