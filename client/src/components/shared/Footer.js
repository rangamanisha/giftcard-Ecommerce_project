        ...
        <Row>
          <Col md={4}>
            ...
            <div>
              ...
              <a href="https://www.youtube.com/channel/UCdCdTEynac-Z_w3A3PSSXmg" 
              className="social"
              >
              ...
              <a href="https://www.linkedin.cn/company/giftiglobal"
              className="social"
              >
          ...
          <Col md={4} className="Gifti_Global_is mt-5">
            <ul style={{ listStyleType: "none" }}>
              <span>About</span>
              <li className="footer-text-list mt-3" onClick={() => history.push("/terms-and-conditions") } style={{cursor: 'pointer'}}>Terms & Conditions</li>
              <li className="footer-text-list mt-3" onClick={() => history.push("/enquiry") } style={{cursor: 'pointer'}}>FAQS</li>
              <li className="footer-text-list mt-3" onClick={() => history.push("/privacy-policy") } style={{cursor: 'pointer'}}>Privacy Policy</li>
              <li className="footer-text-list mt-3" onClick={() => history.push("/contact-us") } style={{cursor: 'pointer'}}>Contact us</li>
            </ul>
          </Col>
          <Col md={4} className="Gifti_Global_is mt-5">
            <ul style={{ listStyleType: "none" }}>
              ...
              <li className="footer-text-list mt-3">
                ...
                care@giftiglobal.com</li>
            </ul>
          </Col>
        </Row>
        <hr />
        <p className="text-center">Gifti Global - © {date} All Rights Reserved</p>
      </Container>
    </footer>
  );
};
