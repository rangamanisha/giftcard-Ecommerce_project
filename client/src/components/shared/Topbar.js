...
const Topbar = (props) => {
    ...
    const { bg, variant, logoIcon, locationIcon, country, countriesList, searchIcon, userLoginIcon, shoppingCartIcon, showLogin, onCountrySelected, profileIcon, coinsIcon, exitIcon, cartIcon, first_name } = props;
