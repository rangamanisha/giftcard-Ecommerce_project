...
import {termBrand,descriptionBrand, product_description, featured_brands, brands_by_category, allBrand } from '../services/brands.service';
...
export const descriptionBrandAction = createAsyncThunk('brands', async(payload, thunkAPI) => {
    const request = {
        id:payload.id,
