...
import {cartItemsService, fetchItemsByCartService, addRemoveQuantityService, cartTotalCountService} from '../services/cart.service';
...
export const cartTotalCountAction = createAsyncThunk('cart_items/listcountTotal', async(payload, thunkAPI) => {
    const request = {
        currency:payload.currency
